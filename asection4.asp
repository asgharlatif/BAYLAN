...
Stxt="SELECT   * FROM  Amainopt WHERE     msection = 'sectionD'"
...
<%
sqltxt2="select *,[dbo].Editprice(pga * "& price &") as pga,[dbo].EditPrice(retail* " & price &" ) as retail from AvPrice  where showmp= 'Yes' and category='"& rsscat("category")& "'" 
